...
public class Registration extends JFrame {
	...
	public Registration() {
		...
		JLabel l3 = new JLabel("Email/Phone No :");
		...
		l5_1.setFont(new Font("Times New Roman", Font.BOLD, 15));
		...
		l6_1.setFont(new Font("Times New Roman", Font.BOLD, 15));
		...
		JCheckBox ch4 = new JCheckBox("Dusting");
		...
		JLabel l7 = new JLabel("Rate/Hour: ");
		...
		JToggleButton b2 = new JToggleButton("Apply as a Worker");
		...
		bg.setIcon(new ImageIcon("login1.png"));
		bg.setBounds(0, 32, 1264, 681);
		p1.add(bg);
	}
