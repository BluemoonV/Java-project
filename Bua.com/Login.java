...
public class Login extends JFrame {
	...
	public Login() {
		...
		background.setBounds(548, 0, 782, 681);
		p1.add(background);
		
		JPanel panel = new JPanel();
		panel.setBackground(Color.LIGHT_GRAY);
		panel.setBounds(0, 0, 486, 681);
		p1.add(panel);
		...
		p2.setBounds(0, 0, 486, 681);
		p1.add(p2);
		p2.setLayout(null);
		
		JLabel l2_1 = new JLabel("New label");
		l2_1.setIcon(new ImageIcon("Bua.png"));
		...
		JLabel l1_1 = new JLabel("Name/Email :");
		...
		l2.setBounds(0, 0, 180, 100);
		l2.setIcon(new ImageIcon("Bua.png"));
		panel.add(l2);
		...
		JLabel l1 = new JLabel("Name/Email :");
				...
				try
				{
					...
					{ 
						...
						if(line.equals(user))
						{
							...
							{
								JOptionPane.showMessageDialog(null, "Login Successful.", "Bua.com", JOptionPane.WARNING_MESSAGE);
		...
		lb1.setCursor(cur);
		lb1.setForeground(new Color(30, 145, 255));
		...
		lb2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				p2.setVisible(true);
				JOptionPane.showMessageDialog(null, " Default User Name : admin\nDefault Password : admin", "Info", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		JLabel lb3 = new JLabel("Contribution");
