	...
	public payment() {
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if(t1.getText().isEmpty() || t2.getText().isEmpty() || t3.getText().isEmpty() || t4.getText().isEmpty() || t5.getText().isEmpty() || pass.isEmpty() )
				{
		...
		btnConfirm.setBounds(368, 505, 175, 30);
		p1.add(btnConfirm);
		...
		btnBack.setBounds(697, 10, 175, 30);
		p1.add(btnBack);
	}
}
