...
public class profile extends JFrame {
	...
	public profile() {
		...
		setBounds(new Rectangle(00, 00, 730, 796));
		...
		l1.setIcon(new ImageIcon("default-avatar-photo-placeholder-profile-icon-female-vector.jpg"));
		...
		b1.setBounds(343, 700, 121, 46);
		b1.setBackground(new Color(250, 85, 85));
		b1.setForeground(new Color(250,85,85));
		p1.add(b1);
		
		JLabel l6 = new JLabel("New label");
		l6.setIcon(new ImageIcon("Bua.png"));
		...
		btnBack.setForeground(new Color(250, 85, 85));
		btnBack.setBounds(637, 0, 77, 30);
		p1.add(btnBack);
