...
public class dashboard extends JFrame
{
	...
	public dashboard() {
		...
		l1.setIcon(new ImageIcon("Bua.png"));
		...
		JLabel b1 = new JLabel("Click any Profile to Expand");
		b1.setHorizontalAlignment(SwingConstants.CENTER);
		b1.setFont(new Font("Times New Roman", Font.BOLD, 25));
		b1.setBounds(459, 11, 316, 49);
		b1.setForeground(new Color(250, 80, 85));
		p1.add(b1);
		...
		b2.setBounds(1124, 11, 130, 23);
		b2.setForeground(new Color(250, 85, 85));
		p1.add(b2);
		...
		lblNewLabel.setIcon(new ImageIcon("default-avatar-photo-placeholder-profile-icon-female-vector.jpg"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("default-avatar-photo-placeholder-profile-icon-female-vector.jpg"));
		...
		l2 = new JLabel("");
		l2.setIcon(new ImageIcon("bgd.png"));
		l2.setBounds(0, 0, 1264, 681);
		p1.add(l2);
